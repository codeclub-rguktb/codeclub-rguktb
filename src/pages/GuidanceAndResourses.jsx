                    ...
                    <div className="text-center pb-12 md:pb-16">
                        ...
                        <div className="max-w-3xl mx-auto">
                            ...
                            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                                <a href="" className='flex w-max gap-4'>
                                    <Button ripple={true}>
                                        ...
                                        <span className='text-xl font-bold ml-4 text-black bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400'>Join the Discord</span>
                                    </Button>
                                </a>
