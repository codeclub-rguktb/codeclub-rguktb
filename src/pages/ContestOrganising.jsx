            ...
            <div className="max-w-6xl mt-10 mx-auto px-4 sm:px-6">
                ...
                <div className="pt-8 pb-12 md:pt-32 md:pb-20">
                    ...
                    <div className="text-center pb-12 md:pb-16">
                        <h1 className="text-5xl md:text-6xl font-extrabold leading-tighter tracking-tighter mb-4" data-aos="zoom-y-out">Contest Organising Team</h1>
                            ...
                            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center" data-aos="zoom-y-out" data-aos-delay="300">
                                <a href="https://www.hackerrank.com/" target="blank" className='flex mx-auto w-max gap-4'>
                                    <Button>
                                        ...
                                        <span className='text-xl font-bold ml-4 text-black bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-teal-400'>Participate !!</span>
                                    </Button>
                                </a>
