...
export default function SocialMedia() {
    return (
        <div>
            <div className="flex mb-8 mt-8 justify-center items-center flex-wrap space-x-2">

                {/* <!-- Discord --> */}
                <a href="https://discord.gg/8VamEwvv" target="_blank">
                ...
                {/* <!-- Instagram --> */}
                <a href="https://www.instagram.com/codeclub_rguktb/" target="_blank">
                ...
                {/* <!-- Linkedin --> */}
                <a href="https://www.linkedin.com/in/codeclub-rguktb-80311224b" target="_blank">
                ...
                {/* <!-- Twitter --> */}
                <a href="https://twitter.com/codeclub_rguktB" target="_blank">
